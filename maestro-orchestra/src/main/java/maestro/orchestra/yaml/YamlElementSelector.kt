...
data class YamlElementSelector(
    ...
    val retryTapIfNoChange: YamlScriptableBoolean? = null,
    val waitUntilVisible: YamlScriptableBoolean? = null,
    ...
    val enabled: YamlScriptableBoolean? = null,
    val selected: YamlScriptableBoolean? = null,
    val checked: YamlScriptableBoolean? = null,
    val focused: YamlScriptableBoolean? = null,
    val repeat: Int? = null,
    val delay: Int? = null,
